 ...
 */
@Service
@ConditionalOnProperty(prefix = "kele.doc.fileUpload", name = "type", havingValue = "local", matchIfMissing = true)
public class SysLocalFileUploadServiceImpl implements ISysFileUploadService {
    ...
    public SysLocalFileUploadServiceImpl(KeleDocWebProperties lxDocWebProperties) {
