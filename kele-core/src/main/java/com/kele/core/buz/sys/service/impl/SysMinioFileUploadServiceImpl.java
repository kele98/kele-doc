package com.kele.core.buz.sys.service.impl;

import com.kele.common.enums.ErrorCodeEnum;
import com.kele.common.exception.BusinessException;
import com.kele.core.buz.sys.model.bo.FileUploadBO;
import com.kele.core.other.constants.CommonCons;
import com.kele.core.other.properties.FileUploadProperties;
 ...
 */
@Service
@ConditionalOnProperty(prefix = "kele.doc.fileUpload", name = "type", havingValue = "minio")
public class SysMinioFileUploadServiceImpl implements ISysFileUploadService {
    ...
    public SysMinioFileUploadServiceImpl(KeleDocWebProperties lxDocWebProperties) {
