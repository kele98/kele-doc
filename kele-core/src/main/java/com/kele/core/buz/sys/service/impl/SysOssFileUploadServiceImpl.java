...
import com.kele.core.other.util.oss.OssUtils;
 ...
 */
@Service
@ConditionalOnProperty(prefix = "kele.doc.fileUpload", name = "type", havingValue = "oss")
public class SysOssFileUploadServiceImpl implements ISysFileUploadService {
    ...
    public SysOssFileUploadServiceImpl(KeleDocWebProperties lxDocWebProperties) {
