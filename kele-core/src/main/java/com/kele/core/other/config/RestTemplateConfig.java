...
import com.kele.core.other.properties.RestTemplateProperties;
 ...
 */
@Configuration
@ConditionalOnProperty(prefix = "kele.doc.restTemplate", name = "enable", havingValue = "true", matchIfMissing = true)
